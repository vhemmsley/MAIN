...
function loadings() {
    ...
    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...10%";
    }, 1400)

    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...35%";
    }, 1800)

    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...42%";
    }, 2000)

    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...81%";
    }, 2300)

    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...92%";
    }, 2400)

    var a = setTimeout(function() {
        loading.innerHTML = "Syncing...99%";
    }, 2600)
    ...
    var a = setTimeout(function() {
        loading.innerHTML = "Connecting Manually.";
    }, 4800)
